...
contract BaseERC721 is IERC721 {
    ...
    function mint(address to, uint256 tokenId) public {
        require(/**code*/ to != address(0x0) , "ERC721: mint to the zero address");
        require(/**code*/ _owners[tokenId] == address(0x0), "ERC721: token already minted");
    ...
    function setApprovalForAll(address operator, bool approved) public {
        ...
        /**code*/
        setApprovalForAll(sender, operator, approved);
    }

    function setApprovalForAll(address owner, address operator, bool approved) public {
        require(/**code*/owner != operator, "ERC721: approve to caller");
    ...
    function _exists(uint256 tokenId) internal view returns (bool) {
        /**code*/
        return _owners[tokenId] != address(0x0) || _tokenApprovals[tokenId] != address(0x0);
    }
    ...
    function _isApprovedOrOwner(
        ...
        require(
            /**code*/_owners[tokenId] != address(0x0) || _tokenApprovals[tokenId] != address(0x0),
    ...
    function _transfer(address from, address to, uint256 tokenId) internal {
        require(
           /**code*/_owners[tokenId] == from || _tokenApprovals[tokenId] == from,
            "ERC721: transfer from incorrect owner"
        );
        
        require(/**code*/to != address(0x0), "ERC721: transfer to the zero address");
